...
public class MainMenuScreen implements Screen {
    ...
    public MainMenuScreen(PongB2D pongGame) {
    ...
    public void show() {
        ...
        // create our buttons
        TextButton box2dGame = new TextButton("New Game", menuSkin);
        ...
        table.add(box2dGame).fillX().uniformX();
        ...
        box2dGame.addListener(new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
                // change screen to gameplay
                parent.changeScreen(PongB2D.BOX2D, PongB2D.MAIN_MENU);
            }
        });
        ...
        preferences.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                parent.changeScreen(PongB2D.PREFERENCES, PongB2D.MAIN_MENU);
            }
        });
