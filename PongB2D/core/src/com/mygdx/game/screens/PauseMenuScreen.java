...
public class PauseMenuScreen implements Screen {
    ...
    public PauseMenuScreen(PongB2D pongGame) {
    ...
    public void show() {
        ...
        resume.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                parent.changeScreen(PongB2D.BOX2D, PongB2D.PAUSE);
            }
        });
        ...
        preferences.addListener(new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
                parent.changeScreen(PongB2D.PREFERENCES, PongB2D.PAUSE);
            }
        });
        ...
        quit.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                parent.clearGame();
                parent.changeScreen(PongB2D.MAIN_MENU, PongB2D.PAUSE);
            }
        });
    }
